...
export default class App extends Component {
  ...
  componentDidMount(){
    ...
    loadScript('./js/sb-admin-2.min.js');
    loadScript('./vendor/jquery-easing/jquery.easing.min.js');
    loadScript('./vendor/chart.js/Chart.min.js');
    loadScript('./js/demo/chart-area-demo.js');
    loadScript('./js/demo/chart-pie-demo.js');
  }
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li className="nav-item">
              <button className="nav-link collapsed" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" 
              aria-controls="collapseUtilities"
              onClick={ this.toggleMenu }>
                <i className="fas fa-fw fa-wrench"></i>
                <span>Utilities</span>
              </button>
              <div id="collapseUtilities" className={"collapse navbar-collapse " + show} aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
